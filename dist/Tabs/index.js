...
var useInsertionEffect = s__namespace['useInsertion' + 'Effect'] ? s__namespace['useInsertion' + 'Effect'] : function useInsertionEffect(create) {
  create();
};
...
var Insertion = function Insertion(_ref) {
  ...
  if (!isBrowser$1 && rules !== undefined) {
    ...
    return /*#__PURE__*/s.createElement("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedNames, _ref2.dangerouslySetInnerHTML = {
      __html: rules
  ...
  return function () {
    ...
    var Styled = react.withEmotionCache(function (props, cache, ref) {
      ...
      if (props.theme == null) {
        ...
        mergedProps.theme = s.useContext(react.ThemeContext);
      }
      ...
      newProps.ref = ref;
      return /*#__PURE__*/s.createElement(s.Fragment, null, /*#__PURE__*/s.createElement(Insertion, {
        cache: cache,
        serialized: serialized,
        isStringTag: typeof FinalTag === 'string'
      }), /*#__PURE__*/s.createElement(FinalTag, newProps));
    });
...
const useLayoutEffect = Boolean(null === globalThis || void 0 === globalThis ? void 0 : globalThis.document) ? s__namespace.useLayoutEffect : () => {};

const r = s__namespace["useId".toString()] || (() => {});

let n$1 = 0;
function useId(o) {
  const [u, i] = s__namespace.useState(r());
  return useLayoutEffect(() => {
    o || i(t => null != t ? t : String(n$1++));
  }, [o]), o || (u ? `radix-${u}` : "");
}

function useCallbackRef(r) {
  const t = s__namespace.useRef(r);
  return s__namespace.useEffect(() => {
    t.current = r;
  }), s__namespace.useMemo(() => (...e) => {
    var r;
...
function useControllableState({
  ...
  const [a, u] = function ({
    ...
    const n = s__namespace.useState(o),
          [a] = n,
          u = s__namespace.useRef(a),
          c = useCallbackRef(r);
    return s__namespace.useEffect(() => {
  ...
  return [f, s__namespace.useCallback(e => {
    if (c) {
      const t = e,
...
function useComposedRefs(...e) {
  return s__namespace.useCallback(composeRefs(...e), e);
}

const Slot = /*#__PURE__*/s__namespace.forwardRef((e, o) => {
  const {
    children: a,
    ...s
  } = e;
  return s__namespace.Children.toArray(a).some(l$2) ? /*#__PURE__*/s__namespace.createElement(s__namespace.Fragment, null, s__namespace.Children.map(a, e => l$2(e) ? /*#__PURE__*/s__namespace.createElement(n, _extends({}, s, {
    ref: o
  }), e.props.children) : e)) : /*#__PURE__*/s__namespace.createElement(n, _extends({}, s, {
    ref: o
  }), a);
});
Slot.displayName = "Slot";
const n = /*#__PURE__*/s__namespace.forwardRef((r, n) => {
  const {
    children: l,
    ...a
  } = r;
  ...
  return s__namespace.isValidElement(l) ? /*#__PURE__*/s__namespace.cloneElement(l, { ...o(a, l.props),
    ref: composeRefs(n, l.ref)
  }) : s__namespace.Children.count(l) > 1 ? s__namespace.Children.only(null) : null;
});
n.displayName = "SlotClone";
const Slottable = ({
  children: e
}) => /*#__PURE__*/s__namespace.createElement(s__namespace.Fragment, null, e);

function l$2(e) {
  
  return s__namespace.isValidElement(e) && e.type === Slottable;
}
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o, i) => ({ ...o,
  [i]: /*#__PURE__*/s__namespace.forwardRef((o, m) => {
    const {
      asChild: a,
      ...s
    } = o,
    ...
    }, []), /*#__PURE__*/s__namespace.createElement(n, _extends({}, s, {
      ref: m
    }));
  })
}), {});
...
function createContextScope(n, o = []) {
  ...
  const c = () => {
    const t = r.map(t => /*#__PURE__*/s__namespace.createContext(t));
    return function (o) {
      const r = (null == o ? void 0 : o[n]) || t;
      return s__namespace.useMemo(() => ({
        [`__scope${n}`]: { ...o,
          [n]: r
        }
      }), [o, r]);
  ...
  return c.scopeName = n, [function (t, o) {
    const c = /*#__PURE__*/s__namespace.createContext(o),
          u = r.length;
    ...
    function s(t) {
      const {
        ...
        ...s
            ...
            a = s__namespace.useMemo(() => s, Object.values(s));
      

      return s__namespace.createElement(i.Provider, {
        value: a
      }, r);
    }
...
function createCollection(c) {
  const n = c + "CollectionProvider",
    ...
    const {
      ...
      children: t
          ...
          c = s__default["default"].useRef(null),
          n = s__default["default"].useRef(new Map()).current;
    

    return s__default["default"].createElement(f, {
      scope: r,
      itemMap: n,
      collectionRef: c
    }, t);
        ...
        m = c + "CollectionSlot",
        s = /*#__PURE__*/s__default["default"].forwardRef((t, c) => {
    const {
      scope: n,
      children: l
    } = t,
    ...
    return s__default["default"].createElement(Slot, {
      ref: f
    }, l);
  }),
        p = c + "CollectionItemSlot",
        d = "data-radix-collection-item",
        R = /*#__PURE__*/s__default["default"].forwardRef((t, c) => {
    const {
      scope: n,
      children: l,
      ...i
    } = t,
          f = s__default["default"].useRef(null),
          u = useComposedRefs(c, f),
          m = a(p, n);
    return s__default["default"].useEffect(() => (m.itemMap.set(f, {
      ref: f,
      ...i
    }), () => {
      m.itemMap.delete(f);
    })), /*#__PURE__*/s__default["default"].createElement(Slot, {
      [d]: "",
      ref: u
    }, l);
  });
  ...
  return [{
    ...
    return s__default["default"].useCallback(() => {
...
const f$1 = {
  ...
  cancelable: !0
      ...
      [d$1, v] = createContextScope("RovingFocusGroup", [m$1]);
const [g, F] = d$1("RovingFocusGroup");
const RovingFocusGroup = /*#__PURE__*/s__namespace.forwardRef((e, o) => /*#__PURE__*/s__namespace.createElement(p$1.Provider, {
  scope: e.__scopeRovingFocusGroup
}, /*#__PURE__*/s__namespace.createElement(p$1.Slot, {
  scope: e.__scopeRovingFocusGroup
}, /*#__PURE__*/s__namespace.createElement(w, _extends({}, e, {
  ref: o
})))));


const w = /*#__PURE__*/s__namespace.forwardRef((t, n) => {
  const {
    ...
    onChange: w
        ...
        [T, A] = s__namespace.useState(!1),
        y = useCallbackRef(b),
        D = l$1(c),
        S = s__namespace.useRef(!1);
  return s__namespace.useEffect(() => {
    const e = E.current;
    if (e) return e.addEventListener("rovingFocusGroup.onEntryFocus", y), () => e.removeEventListener("rovingFocusGroup.onEntryFocus", y);
  }, [y]), /*#__PURE__*/s__namespace.createElement(g, {
    scope: c,
    orientation: p,
    dir: m,
    loop: d,
    currentTabStopId: G,
    onItemFocus: s__namespace.useCallback(e => h(e), [h]),
    onItemShiftTab: s__namespace.useCallback(() => A(!0), [])
  }, /*#__PURE__*/s__namespace.createElement(Primitive.div, _extends({
    tabIndex: T ? -1 : 0,
    "data-orientation": p
  }, x, {
    ref: I,
...
const RovingFocusGroupItem = /*#__PURE__*/s__namespace.forwardRef((e, o) => {
  const {
  ...
  return s__namespace.createElement(p$1.ItemSlot, {
    scope: n,
    id: m,
    focusable: i,
    active: c
  }, /*#__PURE__*/s__namespace.createElement(Primitive.span, _extends({
    tabIndex: v ? 0 : -1,
...
const [d, l] = createContextScope("Tabs", [v]);
const u = v(),
      [b, p] = d("Tabs");
const Tabs$1 = /*#__PURE__*/s__namespace.forwardRef((t, o) => {
  const {
    __scopeTabs: n,
    value: i,
    onValueChange: d,
  ...
  return s__namespace.createElement(b, {
    scope: n,
    baseId: useId(),
    value: v,
    onValueChange: T,
...
const TabsList$1 = /*#__PURE__*/s__namespace.forwardRef((e, o) => {
  const {
    __scopeTabs: r,
    loop: n = !0,
    ...i
  ...
  return s__namespace.createElement(Root$1, _extends({
    asChild: !0
  }, l, {
...
const TabsTrigger = /*#__PURE__*/s__namespace.forwardRef((e, o) => {
  const {
    __scopeTabs: r,
    value: n,
    disabled: d = !1,
  ...
  return s__namespace.createElement(Item, _extends({
    asChild: !0
  }, v, {
    focusable: !d,
    active: g
  }), /*#__PURE__*/s__namespace.createElement(Primitive.button, _extends({
    type: "button",
    role: "tab",
    "aria-selected": g,
    "aria-controls": x,
...
const TabsContent = /*#__PURE__*/s__namespace.forwardRef((e, t) => {
  const {
    __scopeTabs: o,
    value: r,
    children: n,
  ...
  return s__namespace.createElement(Primitive.div, _extends({
