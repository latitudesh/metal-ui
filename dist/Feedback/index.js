...
function composeRefs$3(...o) {
  return e => o.forEach(o => function (o, e) {
    "function" == typeof o ? o(e) : null != o && (o.current = e);
  }(o, e));
}
function useComposedRefs$3(...e) {
  return React__namespace.useCallback(composeRefs$3(...e), e);
}
...
const Presence = u => {
  const {
    ...
    present: s.isPresent
        ...
        c = useComposedRefs$3(s.ref, a.ref);
...
function composeRefs$2(...o) {
  return e => o.forEach(o => function (o, e) {
    "function" == typeof o ? o(e) : null != o && (o.current = e);
  }(o, e));
}
function useComposedRefs$2(...e) {
  return React__namespace.useCallback(composeRefs$2(...e), e);
}
...
const [p, l] = createContext$1("Popper");
const Popper = ({
  children: e
}) => {
...
const [f, d] = createContext$1("PopperContent");
