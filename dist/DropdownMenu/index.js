...
function createContextScope$2(n, o = []) {
  let r = [];
...
const n$5 = {
  ...
  current: 0
      ...
      [t$6, i$4] = createContext$1("IdProvider", n$5);
function useId$1(e) {
  const o = i$4("IdProviderConsumer");
  return Boolean(null === globalThis || void 0 === globalThis ? void 0 : globalThis.document) || o !== n$5 || console.warn("When server rendering, you must wrap your application in an <IdProvider> to ensure consistent ids are generated between the client and server."), E__namespace.useMemo(() => e || `radix-id-${o.prefix}-${++o.current}`, [e]);
}
...
function createContextScope$1(n, o = []) {
  let r = [];
...
const n$4 = {
  ...
  current: 0
      ...
      [t$4, i$3] = createContext("IdProvider", n$4);
function useId(e) {
  const o = i$3("IdProviderConsumer");
  return Boolean(null === globalThis || void 0 === globalThis ? void 0 : globalThis.document) || o !== n$4 || console.warn("When server rendering, you must wrap your application in an <IdProvider> to ensure consistent ids are generated between the client and server."), E__namespace.useMemo(() => e || `radix-id-${o.prefix}-${++o.current}`, [e]);
}
...
function useFocusGuards() {
  E__namespace.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", null !== (e = r[0]) && void 0 !== e ? e : o$5()), document.body.insertAdjacentElement("beforeend", null !== (n = r[1]) && void 0 !== n ? n : o$5()), t$3++, () => {
...
const Slot$1 = /*#__PURE__*/E__namespace.forwardRef((e, o) => {
  const {
    children: a,
    ...s
  } = e,
        c = E__namespace.Children.toArray(a);
  return c.some(l$5) ? /*#__PURE__*/E__namespace.createElement(E__namespace.Fragment, null, c.map(e => l$5(e) ? /*#__PURE__*/E__namespace.createElement(n$3, _extends({}, s, {
    ref: o
  }), e.props.children) : e)) : /*#__PURE__*/E__namespace.createElement(n$3, _extends({}, s, {
    ref: o
  }), a);
});
Slot$1.displayName = "Slot";
const n$3 = /*#__PURE__*/E__namespace.forwardRef((r, n) => {
  const {
    children: l,
    ...a
  } = r;
  ...
  return E__namespace.isValidElement(l) ? /*#__PURE__*/E__namespace.cloneElement(l, { ...o$4(a, l.props),
    ref: composeRefs$3(n, l.ref)
...
function l$5(e) {
  ...
  return E__namespace.isValidElement(e) && e.type === Slottable$1;
}
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "p", "span", "svg", "ul"].reduce((t, s) => ({ ...t,
  [s]: /*#__PURE__*/E__namespace.forwardRef((t, n) => {
    ...
    }, []), t.as && console.error(o$3), /*#__PURE__*/E__namespace.createElement(d, _extends({}, m, {
      ref: n
    }));
  })
}), {});
...
function useComposedRefs$1(...e) {
  return E__namespace.useCallback(composeRefs$2(...e), e);
}
...
function useComposedRefs(...e) {
  return E__namespace.useCallback(composeRefs$1(...e), e);
}
...
const Slot = /*#__PURE__*/E__namespace.forwardRef((e, o) => {
  const {
    ...
    ...s
        ...
        c = E__namespace.Children.toArray(a);
  return c.some(l$4) ? /*#__PURE__*/E__namespace.createElement(E__namespace.Fragment, null, c.map(e => l$4(e) ? /*#__PURE__*/E__namespace.createElement(n$2, _extends({}, s, {
    ref: o
...
const n$2 = /*#__PURE__*/E__namespace.forwardRef((r, n) => {
  ...
  return E__namespace.isValidElement(l) ? /*#__PURE__*/E__namespace.cloneElement(l, { ...o$2(a, l.props),
    ref: composeRefs$1(n, l.ref)
  }) : E__namespace.Children.count(l) > 1 ? E__namespace.Children.only(null) : null;
});
...
const f$4 = {
  ...
  cancelable: !0
      ...
      [d$3, v$1] = createContextScope$1("RovingFocusGroup", [m$3]);
...
const w$1 = /*#__PURE__*/E__namespace.forwardRef((t, n) => {
  const {
    ...
    ...x
        ...
        I = useComposedRefs$1(n, E),
        [G = null, h] = useControllableState$1({
    prop: v,
    defaultProp: F,
    onChange: w
  }),
        [T, A] = E__namespace.useState(!1),
        y = useCallbackRef$2(b),
        D = l$3(c),
  ...
  return E__namespace.useEffect(() => {
    ...
    onMouseDown: composeEventHandlers$1(t.onMouseDown, () => {
      S.current = !0;
    }),
    onFocus: composeEventHandlers$1(t.onFocus, e => {
      const o = !S.current;
    ...
    onBlur: composeEventHandlers$1(t.onBlur, () => A(!1))
  })));
});
const RovingFocusGroupItem = /*#__PURE__*/E__namespace.forwardRef((e, o) => {
  ...
  return E__namespace.createElement(p$2.ItemSlot, {
    ...
    onFocus: composeEventHandlers$1(e.onFocus, () => d.onItemFocus(m)),
...
const Portal = /*#__PURE__*/E__namespace.forwardRef((i, a) => {
  var d, n;
  const {
    containerRef: m,
    style: s,
    ...u
        ...
        c = null !== (d = null == m ? void 0 : m.current) && void 0 !== d ? d : null === globalThis || void 0 === globalThis || null === (n = globalThis.document) || void 0 === n ? void 0 : n.body,
        [, f] = E__namespace.useState({});
  return useLayoutEffect(() => {
    f({});
  }, []), c ? /*#__PURE__*/e__default['default'].createPortal( /*#__PURE__*/E__namespace.createElement(Primitive.div, _extends({
    "data-radix-portal": ""
  }, u, {
    ref: a,
...
const [c$2, l$2] = createContextScope$1("Popper");
...
const Presence = u => {
  const {
    ...
    present: s.isPresent
        ...
        a = useComposedRefs$1(s.ref, c.ref);
...
const FocusScope = /*#__PURE__*/E__namespace.forwardRef((i, f) => {
  const {
    ...
    ...E
        ...
        b = useCallbackRef$2(p),
        T = useCallbackRef$2(v),
        y = E__namespace.useRef(null),
        L = useComposedRefs$1(f, e => S(e)),
  ...
  E__namespace.useEffect(() => {
    ...
    if (F) {
      ...
      if (!F.contains(e)) {
        const t = new Event("focusScope.autoFocusOnMount", c$1);
      ...
      return () => {
        F.removeEventListener("focusScope.autoFocusOnMount", b), setTimeout(() => {
          const t = new Event("focusScope.autoFocusOnUnmount", c$1);
  ...
  const x = E__namespace.useCallback(e => {
    if (!l && !m) return;
    if (h.paused) return;
...
const E = /*#__PURE__*/E__namespace.forwardRef((r, a) => {
  ...
  return E__namespace.createElement(l$1, {
    ...
    onPointerDownCapture: composeEventHandlers$1(r.onPointerDownCapture, R),
    onBlurCapture: composeEventHandlers$1(r.onBlurCapture, h),
    onFocusCapture: composeEventHandlers$1(r.onFocusCapture, F)
  }))));
});
...
const x = ["Enter", " "],
  ...
  rtl: ["ArrowRight"]
      ...
      [D$1, S] = createContextScope$1("Menu", [P, l$2, v$1]);
const O = l$2(),
      T = v$1(),
      [L, A] = D$1("Menu");
const Menu = e => {
...
const G = /*#__PURE__*/E__namespace.forwardRef((e, t) => A("MenuContent", e.__scopeMenu).modal ? /*#__PURE__*/E__namespace.createElement(U, _extends({}, e, {
  ...
  const {
    ...
    ...D
        ...
        B = useComposedRefs$1(n, X, S.onContentChange),
  ...
  return E__namespace.createElement(N, null, /*#__PURE__*/E__namespace.createElement(Q, $, /*#__PURE__*/E__namespace.createElement(F, {
    ...
    asChild: !0,
    trapped: i,
    onMountAutoFocus: composeEventHandlers$1(s, e => {
      var t;
    ...
    onKeyDown: composeEventHandlers$1(D.onKeyDown, e => {
      const t = e.target,
    ...
    onPointerMove: composeEventHandlers$1(e.onPointerMove, J(e => {
      const t = e.target,
...
const MenuItem = /*#__PURE__*/E__namespace.forwardRef((e, t) => {
  ...
  return E__namespace.createElement(Y, _extends({}, o, {
    ref: i,
    disabled: n,
    onClick: composeEventHandlers$1(e.onClick, () => {
      const e = u.current;
    ...
    onPointerUp: composeEventHandlers$1(e.onPointerUp, e => {
      var t;
...
const Y = /*#__PURE__*/E__namespace.forwardRef((e, t) => {
  ...
  return E__namespace.useEffect(() => {
    ...
    onPointerLeave: composeEventHandlers$1(e.onPointerLeave, J(e => a.onItemLeave(e)))
  }))));
});
...
const [s, i] = createContextScope$2("DropdownMenu", [S]);
const l = S(),
      [m, w] = s("DropdownMenu");
const DropdownMenu = e => {
  const {
    ...
    onChange: c
        ...
        g = E__namespace.useCallback(() => D(e => !e), [D]);
  return s.isInsideContent ? /*#__PURE__*/E__namespace.createElement(m, {
    scope: n,
    isRootMenu: !1,
    open: w,
    onOpenChange: D,
    onOpenToggle: g
  }, /*#__PURE__*/E__namespace.createElement(Sub, _extends({}, i, {
    open: w,
    onOpenChange: D
...
const DropdownMenuTrigger = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  ...
  return s.isRootMenu ? /*#__PURE__*/E__namespace.createElement(Anchor, _extends({
    asChild: !0
  }, i), /*#__PURE__*/E__namespace.createElement(Primitive.button, _extends({
    type: "button",
    id: s.triggerId,
    "aria-haspopup": "menu",
...
const DropdownMenuContent = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  ...
  return E__namespace.createElement(D, {
    scope: r,
    isInsideContent: !0
  }, p.isRootMenu ? /*#__PURE__*/E__namespace.createElement(g, _extends({
    __scopeDropdownMenu: r
  }, c, {
    ref: n
  })) : /*#__PURE__*/E__namespace.createElement(Content$1, _extends({}, a, c, {
    ref: n
  })));
});


const g = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    __scopeDropdownMenu: r,
    portalled: t = !0,
    ...p
