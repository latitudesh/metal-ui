...
var useInsertionEffect = E__namespace['useInsertion' + 'Effect'] ? E__namespace['useInsertion' + 'Effect'] : function useInsertionEffect(create) {
  create();
};
...
var Insertion = function Insertion(_ref) {
  ...
  if (!isBrowser$1 && rules !== undefined) {
    ...
    return /*#__PURE__*/E.createElement("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedNames, _ref2.dangerouslySetInnerHTML = {
      __html: rules
...
var createStyled = function createStyled(tag, options) {
  ...
  return function () {
    ...
    var Styled = react.withEmotionCache(function (props, cache, ref) {
      ...
      newProps.ref = ref;
      return /*#__PURE__*/E.createElement(E.Fragment, null, /*#__PURE__*/E.createElement(Insertion, {
        cache: cache,
        serialized: serialized,
        isStringTag: typeof FinalTag === 'string'
      }), /*#__PURE__*/E.createElement(FinalTag, newProps));
    });
...
let n$3 = 0;
function useId(o) {
  const [u, i] = E__namespace.useState(r$3());
...
const Slot = /*#__PURE__*/E__namespace.forwardRef((e, o) => {
  ...
  return E__namespace.Children.toArray(a).some(l$3) ? /*#__PURE__*/E__namespace.createElement(E__namespace.Fragment, null, E__namespace.Children.map(a, e => l$3(e) ? /*#__PURE__*/E__namespace.createElement(n$2, _extends({}, s, {
    ref: o
...
const Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o, i) => ({ ...o,
  [i]: /*#__PURE__*/E__namespace.forwardRef((o, m) => {
    const {
      asChild: a,
      ...s
    } = o,
    ...
    }, []), /*#__PURE__*/E__namespace.createElement(n, _extends({}, s, {
      ref: m
    }));
  })
}), {});
...
const f$3 = {
  ...
  cancelable: !0
      ...
      [p$1, l$2, m$2] = createCollection("RovingFocusGroup"),
      [d$3, v] = createContextScope("RovingFocusGroup", [m$2]);
const [g$1, F$1] = d$3("RovingFocusGroup");
const RovingFocusGroup = /*#__PURE__*/E__namespace.forwardRef((e, o) => /*#__PURE__*/E__namespace.createElement(p$1.Provider, {
  scope: e.__scopeRovingFocusGroup
}, /*#__PURE__*/E__namespace.createElement(p$1.Slot, {
  scope: e.__scopeRovingFocusGroup
  ...
  return E__namespace.useEffect(() => {
    ...
    onFocus: composeEventHandlers(t.onFocus, e => {
      ...
      if (e.target === e.currentTarget && o && !T) {
        const o = new Event("rovingFocusGroup.onEntryFocus", f$3);
...
const RovingFocusGroupItem = /*#__PURE__*/E__namespace.forwardRef((e, o) => {
  ...
  return E__namespace.createElement(p$1.ItemSlot, {
    scope: n,
    id: m,
    focusable: i,
    active: c
...
const [c$2, l$1] = createContextScope("Popper");
const [f$2, d$2] = c$2("Popper");
const Popper = e => {
  const {
    __scopePopper: o,
    children: r
  ...
  return E__namespace.createElement(f$2, {
    scope: o,
    anchor: t,
    onAnchorChange: n
  }, r);
...
const [u$1, m$1] = c$2("PopperContent");
const PopperContent = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  ...
  }, /*#__PURE__*/E__namespace.createElement(u$1, {
    scope: c,
    arrowStyles: L,
    onArrowChange: O,
...
const u = /*#__PURE__*/E__namespace.createContext({
  layers: new Set(),
  layersWithOutsidePointerEventsDisabled: new Set(),
  branches: new Set()
});
const DismissableLayer = /*#__PURE__*/E__namespace.forwardRef((l, m) => {
  const {
    ...
    ...w
        ...
        h = E__namespace.useContext(u),
        [D, x] = E__namespace.useState(null),
        [, C] = E__namespace.useState({}),
...
const x = ["Enter", " "],
  ...
  rtl: ["ArrowRight"]
      ...
      [D$1, S] = createContextScope("Menu", [P, l$1, v]);
const O = l$1(),
      T = v(),
      [L, A] = D$1("Menu");
const Menu = e => {
...
const MenuAnchor = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    __scopeMenu: t,
    ...r
  } = e,
...
const MenuContent = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    forceMount: t,
    ...r
  } = e,
...
const G = /*#__PURE__*/E__namespace.forwardRef((e, n) => A("MenuContent", e.__scopeMenu).modal ? /*#__PURE__*/E__namespace.createElement(U, _extends({}, e, {
  ref: n
})) : /*#__PURE__*/E__namespace.createElement(V, _extends({}, e, {
  ref: n
}))),
      U = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const t = A("MenuContent", e.__scopeMenu),
        r = E__namespace.useRef(null),
        o = useComposedRefs(n, r);
  return E__namespace.useEffect(() => {
    const e = r.current;
    ...
    onDismiss: () => t.onOpenChange(!1)
      ...
      V = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const t = A("MenuContent", e.__scopeMenu);
  ...
  return E__namespace.createElement(B, _extends({}, e, {
    ...
    onDismiss: () => t.onOpenChange(!1)
      ...
      X = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const t = A("MenuContent", e.__scopeMenu),
        r = E__namespace.useRef(null),
        o = useComposedRefs(n, r);
  return t.isSubmenu ? /*#__PURE__*/E__namespace.createElement(B, _extends({
    id: t.contentId,
    ...
    onKeyDown: composeEventHandlers(e.onKeyDown, e => {
      ...
      B = /*#__PURE__*/E__namespace.forwardRef((e, t) => {
  const {
    __scopeMenu: r,
    loop: u = !1,
    trapFocus: i,
    ...
    ...D
        ...
        B = useComposedRefs(t, X, S.onContentChange),
  ...
  const ne = E__namespace.useCallback(e => {
    var n, t;
...
const MenuLabel = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    __scopeMenu: t,
    ...r
  } = e;
...
const MenuItem = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    disabled: t = !1,
    onSelect: r,
    ...o
...
const Y = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    __scopeMenu: t,
    disabled: r = !1,
    textValue: u,
...
const MenuSeparator = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    __scopeMenu: t,
    ...r
  } = e;
...
const [s, i] = createContextScope("DropdownMenu", [S]);
const l = S(),
      [m, w] = s("DropdownMenu");
...
const DropdownMenuTrigger = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  const {
    ...
    ...s
        ...
        m = l(t);
  return i.isRootMenu ? /*#__PURE__*/E__namespace.createElement(Anchor, _extends({
    asChild: !0
...
const DropdownMenuContent = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  ...
  return E__namespace.createElement(D, {
    ...
    ref: n
  })) : /*#__PURE__*/E__namespace.createElement(Content$1, _extends({}, d, a, {
    ref: n
  })));
});
...
const g = /*#__PURE__*/E__namespace.forwardRef((e, n) => {
  ...
  return d.isRootMenu ? /*#__PURE__*/E__namespace.createElement(Content$1, _extends({
    id: d.contentId,
